...
# RENT_SPREADSHEET_ID_TEST = os.environ["RENT_SPREADSHEET_ID_TEST"]

G_MAPS_API = os.environ["G_MAPS_API"]
RENT_SHEET_ID = os.environ["RENT_SHEET_ID"]
# RENT_SHEET_ID_TEST = os.environ["RENT_SHEET_ID_TEST"]
